...
return timeout(_that);case UnexpectedFailure() when unexpected != null:
...
return timeout(_that);case UnexpectedFailure():
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String message,  int? statusCode,  StackTrace? stackTrace)?  network,TResult Function( String message,  int? statusCode,  StackTrace? stackTrace)?  server,TResult Function( String message,  StackTrace? stackTrace)?  cache,TResult Function( String message,  Map<String, String>? errors)?  validation,TResult Function( String message,  StackTrace? stackTrace)?  unauthorized,TResult Function( String message,  StackTrace? stackTrace)?  notFound,TResult Function( String message,  StackTrace? stackTrace)?  timeout,TResult Function( String message,  StackTrace? stackTrace)?  unexpected,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NetworkFailure() when network != null:
return network(_that.message,_that.statusCode,_that.stackTrace);case ServerFailure() when server != null:
return server(_that.message,_that.statusCode,_that.stackTrace);case CacheFailure() when cache != null:
return cache(_that.message,_that.stackTrace);case ValidationFailure() when validation != null:
return validation(_that.message,_that.errors);case UnauthorizedFailure() when unauthorized != null:
return unauthorized(_that.message,_that.stackTrace);case NotFoundFailure() when notFound != null:
return notFound(_that.message,_that.stackTrace);case TimeoutFailure() when timeout != null:
return timeout(_that.message,_that.stackTrace);case UnexpectedFailure() when unexpected != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String message,  int? statusCode,  StackTrace? stackTrace)  network,required TResult Function( String message,  int? statusCode,  StackTrace? stackTrace)  server,required TResult Function( String message,  StackTrace? stackTrace)  cache,required TResult Function( String message,  Map<String, String>? errors)  validation,required TResult Function( String message,  StackTrace? stackTrace)  unauthorized,required TResult Function( String message,  StackTrace? stackTrace)  notFound,required TResult Function( String message,  StackTrace? stackTrace)  timeout,required TResult Function( String message,  StackTrace? stackTrace)  unexpected,}) {final _that = this;
switch (_that) {
case NetworkFailure():
return network(_that.message,_that.statusCode,_that.stackTrace);case ServerFailure():
return server(_that.message,_that.statusCode,_that.stackTrace);case CacheFailure():
return cache(_that.message,_that.stackTrace);case ValidationFailure():
return validation(_that.message,_that.errors);case UnauthorizedFailure():
return unauthorized(_that.message,_that.stackTrace);case NotFoundFailure():
return notFound(_that.message,_that.stackTrace);case TimeoutFailure():
return timeout(_that.message,_that.stackTrace);case UnexpectedFailure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String message,  int? statusCode,  StackTrace? stackTrace)?  network,TResult? Function( String message,  int? statusCode,  StackTrace? stackTrace)?  server,TResult? Function( String message,  StackTrace? stackTrace)?  cache,TResult? Function( String message,  Map<String, String>? errors)?  validation,TResult? Function( String message,  StackTrace? stackTrace)?  unauthorized,TResult? Function( String message,  StackTrace? stackTrace)?  notFound,TResult? Function( String message,  StackTrace? stackTrace)?  timeout,TResult? Function( String message,  StackTrace? stackTrace)?  unexpected,}) {final _that = this;
switch (_that) {
case NetworkFailure() when network != null:
return network(_that.message,_that.statusCode,_that.stackTrace);case ServerFailure() when server != null:
return server(_that.message,_that.statusCode,_that.stackTrace);case CacheFailure() when cache != null:
...
class NetworkFailure extends Failure {
  const NetworkFailure({required this.message, this.statusCode, this.stackTrace}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkFailure&&(identical(other.message, message) || other.message == message)&&(identical(other.statusCode, statusCode) || other.statusCode == statusCode)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}
...
@override
String toString() {
  return 'Failure.network(message: $message, statusCode: $statusCode, stackTrace: $stackTrace)';
}
...
@override
String toString() {
  return 'Failure.server(message: $message, statusCode: $statusCode, stackTrace: $stackTrace)';
}
...
class CacheFailure extends Failure {
  const CacheFailure({required this.message, this.stackTrace}): super._();
...
class ValidationFailure extends Failure {
  const ValidationFailure({required this.message, final  Map<String, String>? errors}): _errors = errors,super._();
...
class UnauthorizedFailure extends Failure {
  const UnauthorizedFailure({required this.message, this.stackTrace}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnauthorizedFailure&&(identical(other.message, message) || other.message == message)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}
...
@override
String toString() {
  return 'Failure.unauthorized(message: $message, stackTrace: $stackTrace)';
}
...
class NotFoundFailure extends Failure {
  const NotFoundFailure({required this.message, this.stackTrace}): super._();
...
class TimeoutFailure extends Failure {
  const TimeoutFailure({required this.message, this.stackTrace}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TimeoutFailure&&(identical(other.message, message) || other.message == message)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}
...
@override
String toString() {
  return 'Failure.timeout(message: $message, stackTrace: $stackTrace)';
}
...
class UnexpectedFailure extends Failure {
  const UnexpectedFailure({required this.message, this.stackTrace}): super._();
