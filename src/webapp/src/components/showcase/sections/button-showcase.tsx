...
export function ButtonShowcase() {
  ...
  return (
    <ComponentDemo
      description={t(($) => $.globalComponents.button.desc)}
      title={t(($) => $.globalComponents.button.title)}
    >
              ...
              <table className="w-full border-collapse text-left">
                <thead>
                  <tr className="border-border text-muted-foreground border-b text-xs">
                    ...
                    <th className="px-4 py-2 font-medium">With Icons</th>
                ...
                <tbody className="divide-border divide-y">
                  {variants.map((v) => (
                    <tr key={v}>
                      ...
                      <td className="px-4 py-3">
                        <Button disabled size={s.key} variant={v}>
                          Button
                        </Button>
                      </td>
                    </tr>
